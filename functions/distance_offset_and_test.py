...
default_parameters = {
    ...
    'cal_dist_points': [
        {'device_angle': -130.0, 'distance': [5000.0, 4000.0, 3000.0]},
        {'device_angle': -90.0, 'distance': [5000.0, 4000.0, 3000.0]},
        {'device_angle': -45.0, 'distance': [5000.0, 4000.0, 3000.0]},
        {'device_angle': 0.0, 'distance': [5000.0, 4000.0, 3000.0]},
        {'device_angle': 45.0, 'distance': [5000.0, 4000.0, 3000.0]},
        {'device_angle': 90.0, 'distance': [5000.0, 4000.0, 3000.0]},
        {'device_angle': 130.0, 'distance': [5000.0, 4000.0, 3000.0]},
    ],
    ...
    'test_dist_points': [
        {'device_angle': -130.0, 'distance': [5000.0, 4000.0, 3000.0, 2000.0, 1000.0, 500.0, 300.0, 250.0, 200.0, 170.0, 150.0, 120.0, 100.0]},
        {'device_angle': -90.0, 'distance': [5000.0, 4000.0, 3000.0, 2000.0, 1000.0, 500.0, 300.0, 250.0, 200.0, 170.0, 150.0, 120.0, 100.0]},
        {'device_angle': -45.0, 'distance': [5000.0, 4000.0, 3000.0, 2000.0, 1000.0, 500.0, 300.0, 250.0, 200.0, 170.0, 150.0, 120.0, 100.0]},
        {'device_angle': 0.0, 'distance': [5000.0, 4000.0, 3000.0, 2000.0, 1000.0, 500.0, 300.0, 250.0, 200.0, 170.0, 150.0, 120.0, 50.0]},
        {'device_angle': 45.0, 'distance': [5000.0, 4000.0, 3000.0, 2000.0, 1000.0, 500.0, 300.0, 250.0, 200.0, 170.0, 150.0, 120.0, 100.0]},
        {'device_angle': 90.0, 'distance': [5000.0, 4000.0, 3000.0, 2000.0, 1000.0, 500.0, 300.0, 250.0, 200.0, 170.0, 150.0, 120.0, 119.0]},
        {'device_angle': 130.0, 'distance': [5000.0, 4000.0, 3000.0, 2000.0, 1000.0, 500.0, 300.0, 250.0, 200.0, 170.0, 150.0, 120.0, 100.0]},
    ],
...
def data_acquisition(input: dict, params: dict) -> dict:
    ...
    stage_etel.rotateTo(py_stage_etel.STAGE_AXIS_INDEX.ROTARY_TARGET, target_angle, params['device_rotation_speed'])
...
def unittest(params: dict = default_parameters):
    ...
    input['test_dist'] = params['test_dist_points']
